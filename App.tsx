            ...
            <div className="space-y-3 sm:space-y-4 flex flex-col items-center w-full">
              <LinkButton onClick={() => setIsCatalogModalOpen(true)}>
                <div className="relative flex items-center justify-center w-full">
                  <div className="absolute left-2 flex items-center justify-center text-amber-300">
                  ...
                  <span className="font-medium">Catálogo e Agendamento</span>
                </div>
              </LinkButton>
              ...
              <LinkButton onClick={() => setIsReviewModalOpen(true)}>
                <div className="relative flex items-center justify-center w-full">
                  ...
                  <span className="font-medium">Avalie sua Experiência</span>
                </div>
              </LinkButton>
            </div>
          </div>
